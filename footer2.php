...
<section id="contact">
		<div class="container footerdiv">
			<div class="row">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 footerbox wow fadeInUp animated" data-wow-duration="1.5s">
					...
					<p>Office Hour: Sun-Thu(10am - 6pm)</p>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 footerbox2">
					...
					<ul class="wow fadeInUp animated" data-wow-duration="1.5s">
						...
						<li><a href="https://www.linkedin.com/in/far-east-it-solutions-ltd-944123142/"><i
		...
		<div class="footercopy" data-aos="zoom-in">
	...
	<script src="js/custom.js"></script>
	 ...
	 <!-- Modal -->
	 <div class="modal fade our-model" id="myModal" role="dialog" style="max-height: 100%;">
		<div class="modal-dialog container-fluid">
		
		  
		  <div class="modal-content" >
			<div class="modal-body text-center our-model-body" >
				<button style="position: absolute; top: 5px; right: 13px; color: red;font-size: 30px;" type="button" class="close" data-dismiss="modal">
					
					<!-- <i class="fa fa-times-circle"></i> -->
					<i class="far fa-times-circle"></i>
				</button>
				
				<img class="viewImg img-fluid rounded" src="images/shopinventory.jpg" alt="">
			</div>
		  </div>
	  ...
	  <script>
		  $(document).on('click', '.portfolio-item', function(){
			  var img= $(this).children('a.model_album').children('img.hidden').attr('src');
